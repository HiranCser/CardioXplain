...
DATA_DIR = '/datasets/efnet1/a4c-video-dir'
...
PHASE_MAX_GAP_RATIO = 1.0  # Maximum ED->ES gap as a fraction of sampled frames
PHASE_PAIR_LOSS_WEIGHT = 0.35  # Train the constrained ED/ES pair decoder used at inference
PHASE_PAIR_SOFT_SIGMA = 2.0  # Gaussian sigma for soft ED/ES pair-distribution targets
PHASE_PAIR_SOFT_RADIUS = 6  # Support radius for each axis of pair-distribution targets
